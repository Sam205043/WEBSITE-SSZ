/* ==========================================================================
   ...
   Mic aur speaker dono ban chuke the (js/chat/voice.js aur Cloud Function
   `novaSpeak`), par 17 Aug 2026 ko UI se hata diye gaye — bolkar poochhna
   bharose ka nahi nikla. Wo file yahan padi hai par koi ise import nahi
   karta, isliye kisi student ke data me se ek byte bhi nahi jaata. Dobara
   chalu karna ho to sirf yahan ke button aur unke handler wapas chahiye.
