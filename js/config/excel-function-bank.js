...
export const EXCEL_FUNCTIONS = {
  ...
  RANK: {
    ...
    tell: (a) => [j(a, 0), " — uska ", j(a, 1), " me kaunsa number aata hai, wo batayega."]
  },
  MEDIAN: {
  ...
  VLOOKUP: {
    ...
    tell: (a) => [j(a, 0), " ko dhundhega ", j(a, 1), " ke pehle column me, aur milne par usi row ke ", j(a, 2), "-ve column ki value wapas dega."],
  ...
  HLOOKUP: {
    ...
    tell: (a) => [j(a, 0), " ko dhundhega ", j(a, 1), " ki pehli row me, aur usi column ki ", j(a, 2), "-vi row ki value dega."]
  },
  XLOOKUP: {
    ...
    tell: (a) => [j(a, 0), " ko dhundhega ", j(a, 1), " me, aur usi jagah ki ", j(a, 2), " wali value dega."],
  ...
  INDEX: {
    ...
    tell: (a) => [j(a, 0), " me row ", j(a, 1), ...(a[2] ? [" aur column ", j(a, 2)] : []), " wali value uthayega."]
  },
  MATCH: {
  ...
  LOOKUP: {
    ...
    tell: (a) => [j(a, 0), " ko dhundhega ", j(a, 1), " me."]
  },
  OFFSET: {
    ...
    tell: (a) => [j(a, 0), " se shuru karke ", j(a, 1), " row aur ", j(a, 2), " column khisak kar wahan ki value uthayega."]
  },
  INDIRECT: {
  ...
  MID: {
    ...
    tell: (a) => [j(a, 0), " ke andar ", j(a, 1), "-ve akshar se ", j(a, 2), " akshar nikaalega."]
  },
  LEN: {
  ...
  SUBSTITUTE: {
    ...
    tell: (a) => [j(a, 0), " — usme ", j(a, 1), " ki jagah ", j(a, 2), " lagayega."]
  },
  REPLACE: { grp: "Text", sig: "REPLACE(text, kahan_se, kitne, naya)", one: "Jagah ke hisaab se badalta hai.", how: "SUBSTITUTE naam se badalta hai, REPLACE jagah se.", tell: (a) => [j(a, 0), " ke andar ", j(a, 1), "-ve akshar se ", j(a, 2), " akshar hata kar ", j(a, 3), " rakh dega."] },
  ...
  TEXT: {
    ...
    tell: (a) => [j(a, 0), " ko dikhayega ", j(a, 1), " wale roop me."]
  },
  ...
  DATEDIF: {
    ...
    tell: (a) => [j(a, 0), " se lekar ", j(a, 1), " tak ka fark ", j(a, 2), " me nikaalega."]
  },
  EDATE: { grp: "Date & time", sig: "EDATE(date, kitne_mahine)", one: "Itne mahine aage/peeche ki date.", how: "EMI ki agli tareekh nikaalne ke liye.", tell: (a) => [j(a, 0), " ke baad ", j(a, 1), " mahine wali date dega."] },
  ...
  NETWORKDAYS: { grp: "Date & time", sig: "NETWORKDAYS(shuru, aakhir, [chhuttiyaan])", one: "Beech ke kaam wale din ginta hai.", how: "Shanivaar-Ravivaar apne aap chhod deta hai.", tell: (a) => [j(a, 0), " aur ", j(a, 1), " ke beech kitne kaam ke din hain, wo ginega."] },
  ...
  ROUND: {
    ...
    tell: (a) => [j(a, 0), " ko gol karega ", j(a, 1), " dashamlav tak."]
  },
  ...
  MOD: { grp: "Number ko sudharna", sig: "MOD(number, bhaajak)", one: "Bhaag dene par bacha hua.", how: "Ek-chhodkar-ek row rangne ke liye MOD(ROW(),2).", tell: (a) => [j(a, 0), " ko bhaag dega ", j(a, 1), " se, aur jo bachega wo dega."] },
  POWER: { grp: "Number ko sudharna", sig: "POWER(number, ghaat)", one: "Ghaat (power).", how: "POWER(2,3) = 8. Ya seedhe 2^3.", tell: (a) => [j(a, 0), " ki ghaat ", j(a, 1), " nikaalega."] },
  ...
  RANDBETWEEN: { grp: "Number ko sudharna", sig: "RANDBETWEEN(neeche, upar)", one: "Do numbers ke beech koi ek.", how: "Practice ka data banane ke liye.", tell: (a) => [j(a, 0), " aur ", j(a, 1), " ke beech koi ek number dega."] },
