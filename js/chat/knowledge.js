  ...
  },
  {
    ...
    answer: () => ({
      text: [
        ...
        "**2. Online** — student dashboard ke Fees page se, \"Abhi pay karein\" dabaakar. UPI, card ya netbanking — sab chalta hai.",
        "",
...
export function groundingFacts() {
  return [
    ...
    "Online fees student dashboard ke Fees page se jama hoti hai (UPI, card ya netbanking). Institute aakar cash bhi de sakte hain.",
